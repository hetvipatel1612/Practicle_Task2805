...
import 'package:application_/models/product_model.dart';
import 'package:application_/res/app_color.dart';
import 'package:application_/src/tabs/product_details.dart';
    ...
    return InkWell(
      onTap: () {
        ...
        Get.to(ProductDetails(
            data.image, data.title, data.description, data.rating, data.price));
      },
      child: Container(
        child: Card(
          elevation: 0,
                ...
                child: Stack(
                  children: [
                    Container(
                      ...
                      child:
                          ExtendedImage.network(data.image ?? "", cache: true),
                    ),
                    if (index % 3 == 0)
                      Positioned(
                        top: 30.w,
              ...
              Row(
                ...
                children: [
                  Expanded(
                    child: Container(
                      padding:
                          EdgeInsets.only(left: 40.w, top: 10.w, bottom: 10.w),
                  ...
                  MaterialButton(
                    ...
                    color: appColor.main,
                    padding:
                        EdgeInsets.symmetric(horizontal: 35.w, vertical: 40.w),
                    materialTapTargetSize: MaterialTapTargetSize.shrinkWrap,
